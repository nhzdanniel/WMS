...
public class HomePageActivityWm extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1 = (CardView) findViewById(R.id.viewProductsWM);
        c2 = (CardView) findViewById(R.id.viewRptsWM);
        c3 = (CardView) findViewById(R.id.approvalSystemWM);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.viewProductsWM:
                i = new Intent(this, ViewProductsWM.class);
                startActivity(i);
                break;
            ...
            case R.id.approvalSystemWM:
                i = new Intent(this, ApprovalSystemWM.class);
                startActivity(i);
                break;
        }
    }
